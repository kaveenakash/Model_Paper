...
var _default = new (_plugin().Runtime)({
  apply({
    ...
    return {
      ...
      !options.serveOptions || options.serveOptions.port !== port) ? port : null)};` + `var HMR_SECURE = ${JSON.stringify(!!(options.serveOptions && options.serveOptions.https))};` + `var HMR_ENV_HASH = "${(0, _utils().md5FromObject)(bundle.env)}";` + `module.bundle.HMR_BUNDLE_ID = ${JSON.stringify(bundle.id)};` + HMR_RUNTIME,
      isEntry: true
    };
  }
